...
//属性管理模块接口地址
enum API {
  // /admin/product/getCategory1 获取—级分类接口
  // /admin/product/getCategory2/{id} 获取二级分类接口
  // /admin/product/getCategory3/{id} 获取三级分类接口
  //获取一级分类接口地址
  C1_URL = '/admin/product/getCategory1',
  //获取二级分类接口地址
  C2_URL = '/admin/product/getCategory2/',//获取三级分类接口地址
  C3_URL = '/admin/product/getCategory3/',
  //获取分类下已有的属性与属性值接口
  ATTR_URL = '/admin/product/attrInfoList/',
