    ...
    <el-card>
        <el-form inline>
            <el-form-item label="一级分类">
                <el-select :disabled="scene === 1" style="width: 200px;margin-right: 20px;" v-model="categoryStore.c1Id"
                    @change="handlerC1">
                    <el-option v-for="c1 in categoryStore.c1Arr" :key="c1.id" :label="c1.name" :value="c1.id" />
                </el-select>
            </el-form-item>
            <el-form-item label="二级分类">
                <el-select :disabled="scene === 1" style="width: 200px;margin-right: 20px;" v-model="categoryStore.c2Id"
                    @change="handlerC2">
                    <el-option v-for="c2 in categoryStore.c2Arr" :key="c2.id" :label="c2.name" :value="c2.id" />
                </el-select>
            </el-form-item>
            <el-form-item label="三级分类">
                <el-select :disabled="scene === 1" style="width: 200px; margin-right: 20px;" v-model="categoryStore.c3Id">
